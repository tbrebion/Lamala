...
/*   Updated: 2022/03/04 14:52:07 by tbrebion         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	display_perso(t_data *data, t_img perso, t_vector vec, int w, int h)
{
	display_floor(data, perso, vec, w, h);
	perso.img = mlx_xpm_file_to_image(data->mlx_ptr, "./img/48megaman.xpm", &w, &h);
